...
export class DepartmentsController {
  ...
  @ApiOperation({
    ...
    description: 'Lấy tất cả các khoa trong hệ thống.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Lấy thông tin chi tiết của một khoa theo ID.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Tạo một đơn vị khoa mới.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Chỉnh sửa thông tin khoa hiện có.',
  })
  @ApiParam({ name: 'id', description: 'ID của khoa', type: Number })
